...
//           </div>
//           <div className=" w-fit rounded-full items-center shadow-lg flex gap-2 px-2 py-2 bg-[#fff] absolute bottom-4 left-1/2 -translate-x-1/2 z-[9]">
...
//                     />
//                     <div className=" mt-8">
//                       <p className={cn(rubik.className)}>{invitation.quote}</p>
//                     </div>
//                   </div>
//                 </section>
//                 <section id="couple">
